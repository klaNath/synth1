...
add wave -noupdate -format Analog-Step -height 74 -max 65530.999999999993 -radix decimal /synth1_test/s1/fifo_in
add wave -noupdate /synth1_test/s1/synth_ctrl
add wave -noupdate /synth1_test/s1/synth_data
add wave -noupdate -format Analog-Step -height 74 -max 2097129.9999999998 -radix unsigned /synth1_test/s1/operator_1/phase_1
...
WaveRestoreCursors {{Cursor 1} {1953885 ps} 0}
...
update
WaveRestoreZoom {1944353 ps} {1978529 ps}
